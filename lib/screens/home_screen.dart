...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _allButtons = [
    ...
    },
    {
      ...
      'description': "Estimaciones sobre el uso de materia prima y producción necesaria.",
  ...
  void _filterButtons() {
    ...
    setState(() {
      _filteredButtons = _allButtons.where((button) {
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/fondo_empanadas.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(
                    ...
                    fontFamily: 'Georgia', // Puedes cambiar por una fuente personalizada si lo deseas
                    letterSpacing: 1.2,
                    color: Colors.brown,
                    shadows: [
                      Shadow(
                ...
                const Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 16,
                    fontFamily: 'Times New Roman', // Otra opción es 'DancingScript'
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: Colors.white.withAlpha((0.9 * 255).toInt()), // 0.9 * 255 = 229.5 ≈ 229
                ...
                SizedBox(
                  height: 90,
                  child: Image.asset('assets/images/La_Planchita_Logo.png'),
                ),
                const SizedBox(height: 16),

                // Botones
                Expanded(
                  child: _filteredButtons.isNotEmpty
                      ? ListView.builder(
